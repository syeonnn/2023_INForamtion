...
def build_model(actions):
    ...
    model.add(tf.keras.layers.LSTM(64, return_sequences=True, input_shape=(30, 258), activation='tanh')) # activation='relu', 
    model.add(tf.keras.layers.LSTM(128, return_sequences=True, activation='tanh')) # , activation='relu'))
    model.add(tf.keras.layers.LSTM(64, return_sequences=False, activation='tanh')) # , activation='relu'))
    model.add(tf.keras.layers.Dense(64, activation='tanh')) # , activation='relu'))
