                ...
                <div class="container px-4 px-lg-5">
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-lg-8 text-center">
                            <h2 class="text-white mt-0">간단한 인삿말과 문장을 배우고 나에게 맞는 단어를 넣어 자기소개를 완성해 보세요!</h2>
                            <hr class="divider divider-light" />
                            <p class="text-white-75 mb-4">농인 사회에서는 이름을 표현할 때 지문자를 쓰기보다 '수어 이름'을 만들어 사용합니다. 보통 외관 상에 드러나는 특징에 따라 이름을 짓는 경우가 많아 '얼굴 이름'이라고도 부릅니다. 이는 농인 사회의 대표적인 문화입니다. <br />따라서, 저희는 지문자를 소개하는 대신 얼굴 이름을 만들어 보길 제안하겠습니다.
